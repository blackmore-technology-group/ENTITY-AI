...
This repository configures the **one ENTITY Global Passport** for the AI domain. It does not define a separate passport protocol and does not modify ENTITY core semantics.
